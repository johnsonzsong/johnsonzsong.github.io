      ...
      <div>
        ...
        <div className="project-container">
          ...
          <section>
            ...
            <p>
              One of the most-used features for users of Goodreads is to keep track of reading history, including books they're currently reading and books they want to read. Simplicity is key in this interaction, since tracking books happens frequently.
            </p>
            <br />
            <p>
          ...
          <section>
            ...
            <div className="image-container nb mt-32 mb-32">
              <img style={{ width: "50%", alignSelf: "center", borderRadius: 32 }} src={grHifi1}></img>
            </div>

            <p>My redesigned discover page allowed me to get creative with visual treatment. Starting from the top, I included a row of searchable tags with keywords and genres for easy access. Under it, I created a scrollable banner to show off the featured books/lists and any announcements from the platform. This was a good way to differentiate this highlighted content versus the rest of the page. Then, instead of having only a list of static genres like the existing Goodreads app, I wanted to make the discover page more personalized and curated. This manifests in a "Hand-picked for you" section of lists recommended to each user. Then, there is another horizontally-scrollable section for recommended books based on ones that the user has enjoyed recently. Underneath, the user can then browse and explore generic categories, like genres.</p>
            <div className="image-container nb mt-32 mb-32">
              <img style={{ width: "50%", alignSelf: "center", borderRadius: 32 }} src={grHifi2}></img>
            </div>
