        ...
        <div className="project-container">
          <section className="text-center">
            ...
            <div className="image-container mt-32 nb">
              <img style={{ width: "50%", alignSelf: "center" }} src={cabanaFeature}></img>
            </div>
            <div className="mt-64">
              ...
              <div className="persona-container">
                ...
                <div className="persona-top">
                  ...
                  <div>
                    ...
                    <p className="m-0">
                      Neil is a 32 year old engineer living in Hawaii. He is married with no children.
                    </p>
                  </div>
                </div>
          ...
          <section>
            ...
            <div className="image-container mt-32">
              <img style={{ width: "50%", alignSelf: "center" }} src={cabanaBrainstorm2}></img>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="image-container mt-32 nb">
              <img style={{ width: "50%", alignSelf: "center" }} src={cabanaPrototype2}></img>
            </div>
            <p className="mt-32">
          ...
          <section>
            ...
            <p className="mb-32">
              Before diving into development, I led efforts to create a fully-interactive high-fidelity prototype. This included defining a basic typographic system, color palette, and visual identity. With the help of a moodboard, we aimed to create a futuristic yet familiar, sleek, and bold vibe that could appeal across generations. Check out our interactive prototype <a href="https://tinyurl.com/cabanatrivia" target="_blank">here</a> and below.
            </p>
            <iframe width={800} height={450} src="https://www.figma.com/embed?embed_host=share&url=https%3A%2F%2Fwww.figma.com%2Fproto%2Fwgkf0Bb5YrHXKGYLv3OfVI%2FCS210-Cabana-Trivia-Master%3Fnode-id%3D9%253A93%26scaling%3Dscale-down" allowfullscreen></iframe>
          </section>

          <section>
            <h2>MVP (LIVE GAME)</h2>
            <p>
              We developed our MVP in React and Firebase. This allowed us to extend our original prototypes to include features like player usernames, high scores, and a leaderboard. Don't just take my word for it - you can actually play our live game by clicking <a href="https://master-dev.d28ds4nnoxwdjw.amplifyapp.com/" target="_blank"> here </a> or on the image below!
            </p>
            <a href="https://master-dev.d28ds4nnoxwdjw.amplifyapp.com/" target="_blank" className="mt-32" style={{ display: "flex", justifyContent: "center" }}>
              <img style={{ width: "50%", alignSelf: "center" }} src={cabanaFeature}></img>
            </a>
          </section>
