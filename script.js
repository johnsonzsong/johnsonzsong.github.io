window.addEventListener('scroll', function() {
  ...
  if (shoutoutsPosition.top <= window.innerHeight/2 && favoritesPosition.top < 0 && favoritesPosition.bottom > 0) {
...
document.addEventListener('mousemove', e => {
  cursor.setAttribute("style", "top: " + (e.clientY - 25)+"px; left: " + (e.clientX - 25) +"px;");
});